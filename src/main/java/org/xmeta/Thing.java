		...
		if(descriptorsNamesStr != null){
			...
			for(String descriptorName : descriptorsNames){
				...
				if(descriptor == null) {
					...
					}else if("xworker.lang.actions.Actions/@GroovyAction".equals(descriptorName)) {
						//Groovy项目从core项目中独立了，如果不引用core项目而直接引用groovy项目那么找不到
						descriptor = world.getThing("xworker.lang.actions.GroovyAction");
					}
				}
				if(descriptor != null){
